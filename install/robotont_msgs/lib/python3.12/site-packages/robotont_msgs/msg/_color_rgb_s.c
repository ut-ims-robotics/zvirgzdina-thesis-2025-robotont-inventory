...
bool robotont_msgs__msg__color_rgb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotont_msgs.msg._color_rgb.ColorRGB", full_classname_dest, 37) == 0);
  }
  robotont_msgs__msg__ColorRGB * ros_message = _ros_message;
  {  // r
...
PyObject * robotont_msgs__msg__color_rgb__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotont_msgs.msg._color_rgb");
