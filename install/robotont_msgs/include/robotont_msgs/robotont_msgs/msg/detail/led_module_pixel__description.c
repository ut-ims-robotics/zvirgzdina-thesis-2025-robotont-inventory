  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xee, 0xcf, 0xbd, 0xab, 0x67, 0xe8, 0x28, 0x54,
      0xb5, 0x4c, 0xac, 0x65, 0x69, 0xd6, 0x96, 0x0e,
      0xe4, 0x97, 0xb6, 0x38, 0x31, 0xcb, 0xe0, 0xb5,
      0xe8, 0xa6, 0x52, 0x8b, 0x5f, 0x00, 0xf7, 0x08,
    }};
  return &hash;
}
...
static char robotont_msgs__msg__LedModulePixel__TYPE_NAME[] = "robotont_msgs/msg/LedModulePixel";
static char robotont_msgs__msg__ColorRGB__TYPE_NAME[] = "robotont_msgs/msg/ColorRGB";

// Define type names, field names, and default values
static char robotont_msgs__msg__LedModulePixel__FIELD_NAME__idx[] = "idx";
static char robotont_msgs__msg__LedModulePixel__FIELD_NAME__color[] = "color";

static rosidl_runtime_c__type_description__Field robotont_msgs__msg__LedModulePixel__FIELDS[] = {
  {
    {robotont_msgs__msg__LedModulePixel__FIELD_NAME__idx, 3, 3},
    {
  ...
  {
    {robotont_msgs__msg__LedModulePixel__FIELD_NAME__color, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription robotont_msgs__msg__LedModulePixel__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {robotont_msgs__msg__ColorRGB__TYPE_NAME, 26, 26},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {robotont_msgs__msg__LedModulePixel__TYPE_NAME, 32, 32},
      {robotont_msgs__msg__LedModulePixel__FIELDS, 2, 2},
    },
    {robotont_msgs__msg__LedModulePixel__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *robotont_msgs__msg__LedModulePixel__get_individual_type_description_source(NULL),
