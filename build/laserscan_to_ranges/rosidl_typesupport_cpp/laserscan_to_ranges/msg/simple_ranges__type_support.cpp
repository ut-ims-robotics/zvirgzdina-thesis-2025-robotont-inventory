...
static const _SimpleRanges_type_support_symbol_names_t _SimpleRanges_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, laserscan_to_ranges, msg, SimpleRanges)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, laserscan_to_ranges, msg, SimpleRanges)),
  }
};
...
{
  return &::laserscan_to_ranges::msg::rosidl_typesupport_cpp::SimpleRanges_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, laserscan_to_ranges, msg, SimpleRanges)() {
  return get_message_type_support_handle<laserscan_to_ranges::msg::SimpleRanges>();
}
